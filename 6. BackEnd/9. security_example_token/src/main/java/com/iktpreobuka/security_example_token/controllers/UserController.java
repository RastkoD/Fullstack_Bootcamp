...
import com.iktpreobuka.security_example_token.entities.dto.UserDTO;
import com.iktpreobuka.security_example_token.repositories.UserRepository;
import com.iktpreobuka.security_example_token.util.Encryption;
...
public class UserController {
	...
	String pwd) {
		...
		return new ResponseEntity<>("Wrong credentials", HttpStatus.UNAUTHORIZED);/* ne vracas tacno sta nije dobro, nego uopste pa neka se snadje */
	}
	...
	public ResponseEntity<?> listUsers() {
		...
		return new ResponseEntity<List<UserEntity>>((List<UserEntity>) userRepository.findAll(),
				HttpStatus.OK);
	}
}
